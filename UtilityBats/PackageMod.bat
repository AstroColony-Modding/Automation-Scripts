...
echo "%cd%\Temp\PackageInput\" "../../../AstroColony/">Temp\Input.txt

::Package the files
echo running UnrealPak
"%UnrealEngineLocation%\Engine\Binaries\Win64\UnrealPak.exe" "%cd%\Temp\%ModName%_P.pak" -Create="%cd%\Temp\Input.txt"
