...
if not exist "%SteamInstall%\AstroColony.exe" set err=1
...
:errHandling
if not exist "%SteamInstall%\AstroColony.exe" echo SteamInstall of "%SteamInstall%" is invalid, please check GlobalConfig.ini and LocalConfig.ini. Note that SteamInstall should be the folder containing AstroColony.exe
